...
def main():
    ...
    parser.add_argument("--pred-frame-offset", type=int, default=None, help="Offset added to prediction frames; if omitted, automatically shifts predictions that start at 0")
    ...
    for frame1 in frames:
        ...
        frame0 = frame1 - 1
        img_path = os.path.join(args.image_root, base_seq, f"{frame0:06d}{args.img_ext}")
